...
- [ ] Implement unit tests first for prompt composition, template discovery, and CLI execution.
...
* **Suggested Approach / Architectural Hints:** Build with Swift or Python/Go with high test coverage and zero heavy dependencies.
